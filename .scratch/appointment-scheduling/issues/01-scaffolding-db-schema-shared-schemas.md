...
- [x] `server/src/db/schema.sql` with all 12 tables: specialties, appointment_types, doctors, doctor_appointment_types, availabilities, availability_blocks, patients, health_insurances, appointments, one_time_links, users, booking_attempts
